...
var gl;
var positions;
var vertices, verticesUpsideDown;
var shaderProgram;
var aPosition, aColor;
var vbo, vboUpsideDown;
...
function initBuffers()
{
	...
	vboUpsideDown = gl.createBuffer();

	gl.bindBuffer(gl.ARRAY_BUFFER, vboUpsideDown);

	gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(verticesUpsideDown), gl.STATIC_DRAW);
}
...
function renderScene()
{
	...
	var stride = (2 + 4) * 4; // (numPosition + numColor) * bytes
